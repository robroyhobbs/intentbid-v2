...
import { 
  ...
  Search, Command, ShieldCheck, Clock, Monitor, Database, Mail, ShieldAlert
} from 'lucide-react';
      ...
      <div className="flex-1 flex min-h-0 relative">
        ...
        <main className="flex-1 overflow-y-auto bg-[#050505] relative custom-scrollbar scroll-smooth">
          <div className="max-w-[850px] mx-auto py-12 px-8 relative z-10">
            ...
            {/* Proposal Readiness Banner */}
            <div className="mb-8 bg-amber-500/10 border border-amber-500/20 p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-none bg-amber-500/20 flex items-center justify-center shrink-0">
                  <ShieldAlert className="w-4 h-4 text-amber-500" />
                </div>
                <div>
                  <h3 className="text-[11px] uppercase tracking-widest font-bold text-amber-500 mb-0.5">Proposal Readiness Blocked</h3>
                  <p className="text-[13px] text-foreground-muted">1 readiness gate issue detected. Scorecard is below release threshold.</p>
                </div>
              </div>
              <button className="px-4 py-2 bg-[#111116] border border-white/10 text-[10px] uppercase tracking-widest font-bold text-foreground hover:bg-white/5 transition-colors">
                View Details
              </button>
            </div>
        ...
        {/* Right Sidebar - Intelligence & Co-Pilot */}
        <aside className="w-80 border-l border-white/5 bg-[#050505] flex flex-col shrink-0 z-30 overflow-y-auto custom-scrollbar">
          <div className="p-4 border-b border-white/5 bg-[#0A0A0A] sticky top-0 z-10">
            <h2 className="text-[10px] uppercase tracking-widest font-bold text-foreground flex items-center gap-2">
          ...
          <div className="p-4 space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <h3 className="text-[10px] uppercase tracking-widest font-bold text-foreground-muted">AI Co-Pilot</h3>
                <span className="bg-electric/10 text-electric px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-widest">2 Suggestions</span>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] uppercase tracking-widest font-bold text-foreground-muted mb-3 leading-relaxed">
                      The "Zero-Downtime Operations" win theme is not explicitly mentioned.
                    </p>
              ...
              <div className="p-3.5 rounded-none border border-white/5 bg-[#0A0A0A] hover:bg-white/5 transition-colors group">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] uppercase tracking-widest font-bold text-foreground-muted mb-3 leading-relaxed">
                      Section L.4 requires explicit acknowledgment of 8(a) status.
                    </p>
                    <button className="w-full py-1.5 rounded-none bg-white/5 hover:bg-white/10 border border-white/5 text-[10px] uppercase tracking-widest font-bold font-medium text-foreground transition-colors flex items-center justify-center gap-1.5">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <h3 className="text-[10px] uppercase tracking-widest font-bold text-foreground-muted">Quality & Compliance</h3>
                ...
                {[
                  ...
                  <div key={metric.label} className="space-y-1.5 group">
                    <div className="flex justify-between text-[9px] uppercase tracking-widest font-bold">
                      <span className="text-foreground-muted group-hover:text-foreground transition-colors">{metric.label}</span>
                      <span className="text-foreground">{metric.score}%</span>
                    </div>
              ...
              <button className="w-full py-2 text-[10px] uppercase tracking-widest font-bold text-foreground-muted hover:text-foreground border border-white/5 bg-[#0A0A0A] hover:bg-white/5 transition-colors mt-2">
                View Full Scorecard
              </button>
            </div>
            ...
            {/* Generation Context (Secret Sauce) */}
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <h3 className="text-[10px] uppercase tracking-widest font-bold text-foreground-muted">Generation Context</h3>
                <span className="text-[9px] font-bold text-foreground-muted uppercase tracking-widest">5 Sources</span>
              </div>
              
              <div className="space-y-2">
                <div className="flex items-center justify-between p-2 border border-white/5 bg-[#0A0A0A]">
                  <div className="flex items-center gap-2">
                    <FileText className="w-3.5 h-3.5 text-foreground-muted" />
                    <span className="text-[10px] uppercase tracking-widest font-bold text-foreground">Source Bundle</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-2 border border-white/5 bg-[#0A0A0A]">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] uppercase tracking-widest font-bold text-foreground">Agency Context</span>
                  </div>
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500" />
                </div>
                <div className="flex items-center justify-between p-2 border border-white/5 bg-[#0A0A0A]">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] uppercase tracking-widest font-bold text-foreground">Evidence Library</span>
                  </div>
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500" />
                </div>
              </div>
          ...
          <div className="mt-auto p-4 bg-[#050505] sticky bottom-0 border-t border-white/5">
            <div className="relative bg-[#0A0A0A] border border-white/10 rounded-none focus-within:border-electric/50 transition-colors flex items-center px-3 py-1.5 group">
              ...
              <input 
                ...
                className="w-full bg-transparent border-none pl-2 pr-8 py-1.5 text-[13px] text-foreground focus:outline-none focus:ring-0 placeholder:text-foreground-muted"
              />
        ...
        <div className="fixed inset-0 z-50 flex justify-center bg-[#050505] animate-in fade-in zoom-in-95 duration-200 overflow-y-auto custom-scrollbar">
          <div className="w-full max-w-5xl p-8 md:p-12 relative">
            ...
            <div className="border-t border-white/5 pt-8">
              <h2 className="text-sm uppercase tracking-widest font-bold text-foreground mb-4">Submission Package</h2>
              <div className="bg-[#0A0A0A] border border-white/5 p-6 space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] uppercase tracking-widest font-bold text-foreground-muted">Delivery Method</span>
                  <span className="text-[13px] text-foreground">Email, Physical delivery</span>
                </div>
                <div className="h-px bg-white/5" />
                <div className="space-y-2">
                  <span className="text-[10px] uppercase tracking-widest font-bold text-foreground-muted flex items-center gap-2">
                    <Mail className="w-3.5 h-3.5" /> Delivery Address
                  </span>
                  <div className="flex items-center gap-2">
                    <input 
                      type="text" 
                      defaultValue="maysjr@state.gov, brownea1@state.gov"
                      className="flex-1 bg-[#111116] border border-white/10 px-3 py-2 text-[13px] text-foreground focus:outline-none focus:border-white/20"
                    />
                    <button className="px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 text-[10px] uppercase tracking-widest font-bold text-foreground transition-colors">
                      Save
                    </button>
                  </div>
                </div>
